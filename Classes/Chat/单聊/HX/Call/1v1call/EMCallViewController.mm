...
{
    [self _stopRing];
    [[DQEaseMobCallManager sharedManager] answerCall:self.callSession.callId];
}
...
- (IBAction)rejectAction:(id)sender
{
    ...
    [[DQEaseMobCallManager sharedManager] hangupCallWithReason:EMCallEndReasonDecline];
}
...
- (IBAction)hangupAction:(id)sender
{
    ...
    [[DQEaseMobCallManager sharedManager] hangupCallWithReason:EMCallEndReasonHangup];
}
