...
static NSString * const OpenSSL_publicBase64KeyChainTag =@"OpenSSL_publickeyTag_Base64";

static NSString * const OpenSSL_certTag =@"OpenSSL_certTag_Seckey";
...
+ (BOOL)deleteStringWithIdentifier:(NSString *)identifier;
